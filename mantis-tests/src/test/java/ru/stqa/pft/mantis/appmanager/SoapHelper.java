...
public class SoapHelper {
    ...
    public Set<Project> getProjects() throws MalformedURLException, RemoteException, ServiceException {
        // соединяемся с Мантисом
        MantisConnectPortType mc = getMantisConnect();

        //получить список проектов, к которым указанный юзер имеет доступ
        ProjectData[] projects = mc.mc_projects_get_user_accessible
                (app.getProperty("soapMantis.adminLogin"), app.getProperty("soapMantis.adminPassword"));
    ...
    public Issue addIssue(Issue issue) throws MalformedURLException, ServiceException, RemoteException {
        ...
        // устанавливаем обязательный парамент "Категория" - первую попавшуюся
    ...
    private MantisConnectPortType getMantisConnect() throws ServiceException, MalformedURLException {
        return new MantisConnectLocator().getMantisConnectPort
                (new URL(app.getProperty("soapMantis.baseURL")));
    }
}
